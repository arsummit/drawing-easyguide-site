      ...
      <div className="mx-auto max-w-[1320px] px-[24px]">
        <div className="grid gap-10 md:grid-cols-[auto_1fr_1fr_1fr] md:gap-16">
          ...
          <div className="flex items-start">
            <img src="/images/logo.png" alt="Drawing Easy Guide" className="h-[80px] w-auto object-contain brightness-0 invert" />
          </div>
        ...
        <div className="mt-12 border-t border-white/20 pt-8 text-center">
          ...
          <p className="mt-4 text-[12px] text-white/70">© 2026, Drawing Easy Guide</p>
        </div>
      </div>
    </footer>
  );
