...
function SuccessContent() {
  ...
  useEffect(() => {
    ...
    try {
      const saved = localStorage.getItem("drawing-cart");
      if (saved) {
    ...
    return (
      <main className="min-h-screen bg-[#f5f5f5] px-6 py-12">
        ...
        <div className="mx-auto mb-10 flex max-w-[640px] justify-center">
          <img src="/images/logo.png" alt="Drawing Easy Guide" className="h-[48px] w-auto object-contain" />
        </div>
  ...
  return (
    <main className="min-h-screen bg-white text-[#111]">
      ...
      <div className="border-b border-[#e8e8e8] px-6 py-5 text-center">
        <p className="text-[18px] font-semibold text-[#222]">Drawing Easy Guide</p>
          ...
          {stage === "downsell" ? (
            <>
              ...
              <h2 className="mt-2 text-[24px] font-extrabold leading-[1.3] text-[#111] sm:text-[28px]">
                The book you just purchased does NOT include any colors or images!
              </h2>
            </>
          ) : (
            <>
              ...
              <h2 className="mt-2 text-[24px] font-extrabold leading-[1.3] text-[#111] sm:text-[28px]">
                Do You Want To Upgrade To The Full Colored Drawing Bundle?
              </h2>
            </>
          )}
        ...
        <div className="grid gap-8 sm:grid-cols-2 sm:items-start">
          ...
          <div className="w-full">
            <img
              ...
              alt="Upgrade to Full Colored Drawing Bundle"
          ...
          <div>
            <h3 className="text-[22px] font-bold leading-[1.3] text-[#111]">
              Upgrade to Full Colored Beginner-Friendly Drawing Bundle
            </h3>
            ...
            {stage === "downsell" ? (
              <div className="mt-5 space-y-4 text-[15px] leading-[1.6] text-[#333]">
                ...
                <p>🎉 This is a <strong>thank-you gift</strong> — for choosing us and trusting us with your drawing journey!</p>
                <p className="font-bold text-[#3a9e5f]">✅ Try It Now! This is our last price drop offer!</p>
              </div>
            ) : (
              <>
                <h4 className="mt-5 text-[17px] font-bold text-[#111]">Thanks for buying our Drawing Easy Guide! :)</h4>
                <div className="mt-3 space-y-2 text-[15px] leading-[1.6] text-[#333]">
                  <p>⚠️ <strong>Standard Drawing Guides</strong> — (Text-based, harder to follow without visual guidance — perfect as a reference)</p>
                  <p>❤️ <strong>Full Colored Drawing Bundle</strong> — Easy-to-follow, beginner-friendly, and visually engaging with step-by-step image guides!</p>
                </div>
                <div className="mt-5 text-[15px] text-[#111]">
                  ...
                  <ul className="mt-2 space-y-1">
                    ...
                    <li>✅ Bonus Drawing References &amp; Templates</li>
                  </ul>
                </div>
        ...
        <div className="mt-14 grid gap-6 grid-cols-1 sm:grid-cols-2 items-center">
          <div className="text-center">
            ...
            <p className="mt-3 text-center text-[16px] leading-[1.7] text-[#444]">
              This Offer Includes a <strong>FREE Mystery Box</strong> filled with drawing essentials worth over{" "}
          ...
          <div className="text-center">
            ...
            <p className="mt-3 text-[15px] text-[#333]">
              Over <strong>$250 Worth</strong> Of Drawing Products For <strong>FREE</strong>
            </p>
          </div>
        </div>
        ...
        <div className="mt-10 grid gap-6 sm:grid-cols-2 items-center">
          ...
          <div>
            <h3 className="text-[22px] font-extrabold leading-[1.35] text-[#111]">
              Upgrade From Black And White To Colorful Drawing Easy Guide and get:
            </h3>
