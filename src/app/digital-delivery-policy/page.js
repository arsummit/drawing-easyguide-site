...
export const metadata = { title: "Digital Delivery Policy — Drawing Easy Guide" };
      ...
      <main className="min-h-screen bg-white px-6 py-16 text-[#222]">
        <div className="mx-auto max-w-[720px]">
          ...
          <p className="mt-8 text-[16px] leading-[1.8] text-[#444]">
            Thank you for your purchase from <strong>Drawing Easy Guide</strong>. All of our products are
          ...
          <ol className="mt-4 space-y-4 text-[16px] leading-[1.8] text-[#444]">
            ...
            <li>
              ...
              download your drawing guides as PDF files at any time. The links do not expire.
            </li>
          </ol>
          ...
          <ul className="mt-3 list-disc pl-6 text-[16px] leading-[1.8] text-[#444]">
            <li><strong>Full Drawing Guide (Upgraded to Colored)</strong> — the complete colored drawing guides collection</li>
            <li><strong>All Extras and Upgrades</strong> — bonus materials, patterns, and gift content</li>
          </ul>
