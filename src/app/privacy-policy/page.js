...
export const metadata = { title: "Privacy Policy — Drawing Easy Guide" };
      ...
      <main className="min-h-screen bg-white px-6 py-16 text-[#222]">
        <div className="mx-auto max-w-[720px]">
          ...
          <p className="mt-8 text-[16px] leading-[1.8] text-[#444]">
            This Privacy Policy describes how <strong>Drawing Easy Guide</strong> ("we", "us", or "our")
            collects, uses, and protects your personal information when you visit{" "}
            <strong>drawing.easyguide.store</strong>.
          </p>
