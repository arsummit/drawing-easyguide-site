...
export const metadata = { title: "Terms of Service — Drawing Easy Guide" };
      ...
      <main className="min-h-screen bg-white px-6 py-16 text-[#222]">
        <div className="mx-auto max-w-[720px]">
          ...
          <p className="mt-8 text-[16px] leading-[1.8] text-[#444]">
            By accessing or purchasing from <strong>drawing.easyguide.store</strong>, you agree to
          ...
          <p className="mt-3 text-[16px] leading-[1.8] text-[#444]">
            To the fullest extent permitted by law, Drawing Easy Guide shall not be liable for any
